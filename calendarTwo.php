...
// $CurrentDate = Date("2023-09-01");
$Calendar = new Calendar("2024-09-01");

$Calendar->add_event("booked", "2024-09-29", 3, "booked");
$Calendar->add_event("booked", "2024-10-21", 3, "pending")
?>
...
<body>
    <div class="mt-4">
        <div class="buttons-icon gap-4 d-flex">
            <i class="bi bi-chevron-left" id="prev" onclick="<?= "" ?>"></i>
            <i class="bi bi-chevron-right" id="next" onclick="<?= "" ?>"></i>
        </div>
        <?php $render = $Calendar->renderCalendar() ;
        echo $render;
...
<!-- <script>
    $(document).ready(function() {
        ...
        function updateCalendar(month, year) {
            ...
            $.ajax({
                type: 'GET',
                url: './Calendar.php', // Your server-side endpoint
                data: {
                    month: activeMonth,
                    year: activeYear
                },
                success: function(response) {
                    ...
                    // $('.calendar__container').html(response +"Expected Response");
